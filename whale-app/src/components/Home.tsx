    ...
    <div className="home">
      <style>{`
        ...
        .home .qcard {
          ...
          text-align: left; transition: border-color .1s, transform .1s;
        }
        .home .qcard:hover { border-color: var(--accent); transform: translateY(-1px); }
        .home .qcard .ic {
        ...
        .stat { background: var(--panel); border: 1px solid var(--border); border-radius: var(--r-md); padding: 12px 14px; }
        ...
        .activity { background: var(--panel); border: 1px solid var(--border); border-radius: var(--r-lg); padding: 4px 0; }
        .activity .arow {
        ...
        .activity .arow:last-child { border-bottom: 0; }
        .activity .arow .ic { color: var(--fg-subtle); }
        .activity .arow .who { color: var(--fg-muted); font-family: var(--font-mono); font-size: 11px; }
        .activity .arow .t { color: var(--fg-faint); font-family: var(--font-mono); font-size: 11px; }
      `}</style>
      ...
      <div className="home-inner">
        ...
        <div className="activity">
          {[
            { ic: 'pipeline' as const, txt: <>Updated <b>Tone Curve</b> on <b>HDR · outdoor portrait</b></>,         who: 'jiwon.k', t: '12:44' },
            { ic: 'check'    as const, txt: <>Approved simulation set <b>night-A-rev7</b> (18 images)</>,             who: 'j.park',  t: '11:02' },
            { ic: 'upload'   as const, txt: <>Uploaded 6 references to <b>ColorChecker SG</b></>,                    who: 'jiwon.k', t: '09:18' },
            { ic: 'tag'      as const, txt: <>Added tag <span className="badge accent">low-light</span> to 14 images</>, who: 's.nam', t: 'Yesterday' },
            { ic: 'folder'   as const, txt: <>Created collection <b>Sensor-A · Night Tuning Pass 3</b></>,           who: 'jiwon.k', t: 'Apr 16' },
          ].map((a, i) => (
